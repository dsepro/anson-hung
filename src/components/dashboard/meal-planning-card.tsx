...
const weeklyPlanData = [
  { day: 'Monday', calories: '1,950 kcal', mealThumbnails: ['https://placehold.co/20x20/A8D5BA/333.png?text=B', 'https://placehold.co/20x20/FFDDA2/333.png?text=L', 'https://placehold.co/20x20/C5E1A5/333.png?text=D'] , dataAiHints: ['breakfast fruit', 'lunch meal', 'dinner food']},
  { day: 'Tuesday', calories: '2,050 kcal', mealThumbnails: ['https://placehold.co/20x20/ADD8E6/333.png?text=B', 'https://placehold.co/20x20/E6B980/333.png?text=L', 'https://placehold.co/20x20/FFABAB/333.png?text=D'] , dataAiHints: ['healthy breakfast', 'quick lunch', 'light dinner']},
  { day: 'Wednesday', calories: '1,850 kcal', mealThumbnails: ['https://placehold.co/20x20/FFCC80/333.png?text=B', 'https://placehold.co/20x20/A8D5BA/333.png?text=L', 'https://placehold.co/20x20/FFDDA2/333.png?text=D'] , dataAiHints: ['morning meal', 'midday food', 'evening supper']},
];
        ...
        <Tabs defaultValue="weekly" className="w-full">
          ...
          <TabsContent value="weekly" className="mt-1 space-y-3">
            <div className="flex justify-between items-center mb-1">
                ...
                <Button variant="link" size="sm" className="text-xs h-auto p-0 text-primary hover:text-primary/80">View All</Button>
            </div>
            {weeklyPlanData.map(plan => (
              <div key={plan.day} className="flex items-center justify-between p-2.5 rounded-md bg-card hover:bg-secondary/10 border border-border/60">
                <div>
