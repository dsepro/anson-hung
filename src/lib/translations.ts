...
export const translations = {
  en: {
    ...
    personalStatementDialogTitle: "Application for the PgD Human Nutrition & Dietetics Programme",
    personalStatementWhyTitle: "Why Nutrition & Dietetics ?",
    personalStatementWhyBody: "While working in Hong Kong hospitals, I observed patients struggling to balance traditional diets with medical nutrition therapy. This inspired me to bridge cultural food practices with evidence-based dietetics—a passion I now wish to formalize through Ulster’s PgD in Human Nutrition & Dietetics. My degree in food and nutritional science equipped me with a strong foundation in biochemistry and metabolic health, while my hospital and volunteer experience (see attached portfolio for details) honed my ability to translate complex dietary guidelines into practical advice for diverse patients. I am committed to empowering individuals to make informed dietary choices that enhance their quality of life.",
    personalStatementExperienceTitle: "My Career Vision",
    digitalHealthToolTitle: "Digital Health Tool",
    digitalHealthToolTarget: "(Target Completion: 1-2 years)",
    digitalHealthToolBody: "I plan to develop a comprehensive app that enables users to track their food intake and estimate nutrient consumption. It will provide personalized recipe recommendations based on health conditions and allow users to monitor key health metrics. By offering accessible nutritional information and guidance, this app can positively impact community nutritional health by raising awareness of healthy eating habits and preventing diet-related diseases. With real-time support from registered dietitians, users will be encouraged to adopt proactive health management, ultimately fostering a healthier community. (An online demo of my app is available at https://anson-hung.netlify.app/)",
    communityNutritionTitle: "Community Nutrition Innovation",
    communityNutritionTarget: "(Target Completion: 3-5 years)",
    communityNutritionBody: "I aim to establish community kitchens that merge traditional Chinese dietary wisdom with precision nutrition. These kitchens will serve as hubs for education, where I wish to offer lessons that inspire healthier cooking and eating habits. This initiative will act as a primary intervention to reduce preventable diseases through early nutritional support and public education. By fostering community engagement, we can promote better health outcomes and create a culture of healthier eating.",
    aiIntegrationTitle: "Artificial Intelligence (AI) Integration",
    aiIntegrationTarget: "(Continuous)",
    aiIntegrationBody: "I wish to integrate AI into nutritional practices to enhance the management of diet-related diseases like diabetes. AI’s ability to analyse vast amounts of data allows for personalized insights that traditional methods cannot provide. For example, I can adapt traditional tong sui (sweet soups) for diabetic patients using predictive analytics to estimate the glycaemic load. By leveraging AI to personalize treatment plans, I aim to empower individuals in their health journeys with tailored dietary solutions that promote healthier eating habits. Ultimately, I hope to reduce the prevalence of diet-related diseases and foster proactive health management within the community.",
    ...
    personalStatementConclusionBody: "My nutritional science background has prepared me to innovate at the intersection of tradition and technology. Through this program, I will gain the clinical expertise to transform Hong Kong’s nutritional landscape, one culturally attuned meal plan at a time.",
  ...
  zh: {
    ...
    // Personal Statement Dialog/Page (Using English text as placeholder)
    personalStatementDialogTitle: "Application for the PgD Human Nutrition & Dietetics Programme",
    personalStatementWhyTitle: "Why Nutrition & Dietetics ?",
    personalStatementWhyBody: "While working in Hong Kong hospitals, I observed patients struggling to balance traditional diets with medical nutrition therapy. This inspired me to bridge cultural food practices with evidence-based dietetics—a passion I now wish to formalize through Ulster’s PgD in Human Nutrition & Dietetics. My degree in food and nutritional science equipped me with a strong foundation in biochemistry and metabolic health, while my hospital and volunteer experience (see attached portfolio for details) honed my ability to translate complex dietary guidelines into practical advice for diverse patients. I am committed to empowering individuals to make informed dietary choices that enhance their quality of life.",
    personalStatementExperienceTitle: "My Career Vision",
